\begin{figure}[thbp]
    ...
    \end{scope}
    \end{tikzpicture}
    \caption{The geometry of the rSVD. A random sample $K\psi$ aligns mostly with the first left singular value. The illustration is inspired by Fig.~9.1 in Tropp \cite{troppACM204Randomized2021}.}
    \label{fig:rsvd}
\end{figure}
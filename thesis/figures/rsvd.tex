\begin{figure}[thbp]
    ...
    \begin{scope}[shift={(0,0)}]
      ...
      \draw[thick,->,Green] (0,0) -- ({2*cos(35)},{2*sin(35)}) node[above right] {$\boldsymbol{\omega}$};
    \end{scope}
    ...
    \begin{scope}[shift={(8,0)}, rotate=25]
      ...
      node[above, xshift=5pt, yshift=2pt] {$K\boldsymbol{\omega}$};
    \end{scope}
    \end{tikzpicture}
    \caption{The geometry of the rSVD. A random sample $K\v\omega$ aligns mostly with the first left singular value. The illustration is inspired by Fig.~9.1 in Tropp \cite{tropp_acm_2021}.}
    \label{fig:rsvd}
\end{figure}
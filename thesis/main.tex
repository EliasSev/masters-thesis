...
\abstract{
  This thesis uses randomized linear algebra for estimation of a discrete PDE operator.
}
\sammendrag{
  Denne masteroppgaven bruker randomisert lineær algebra for mastrise-fri estimering av PDE-operatorer.
}
%\acknowledgements{

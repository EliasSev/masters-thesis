...
\nomenclature[B]{$\sigma$}{Diffusion coefficient}
\nomenclature[B]{$c$}{Reaction coefficient}
...
\nomenclature[C]{$\mathcal{K}^*$}{Adjoint operator}%
...
\nomenclature[E]{$K^*$}{Discrete adjoint operator}%
...
\nomenclature[E]{$W$}{Tikhonov weight matrix}%

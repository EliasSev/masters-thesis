...
Let $V_h$ be the finite element space introduced in Eq.~\eqref{eq:fem_space} and let $f_h, g_h \in V_h$, with coefficient vectors $x, y \in \mathbb{R}^N$, respectively. The $L^2(\Omega)$ inner product (see Appendix~\ref{appendix:functional_analysis_and_the_fem}) of $f_h$ and $g_h$, can be written as
\begin{equation*}
